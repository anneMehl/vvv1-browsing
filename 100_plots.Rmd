...
quickplot(roadtype1, data = browse_9)
quickplot(roadtype2, data = browse_sub)
quickplot(roadtype3, data = browse_sub)

quickplot(sqrt(distvei1), data = browse_9)
quickplot(distroad2, data = browse_sub)
quickplot(distroad3, data = browse_sub)

quickplot(sqrt(disthouse), data = browse_sub)

quickplot(log(slope1), data = browse_sub)

quickplot(sqrt(altitude), data = browse_sub)

quickplot(foresttype, data = browse_sub)

quickplot(bilberrycover, data = browse_sub)

quickplot(browsingpressure, data = browse_sub)
quickplot(sqrt(browsingpressure), data = browse_sub)
quickplot(log(browsingpressure), data = browse_sub)
quickplot(log10(browsingpressure), data = browse_sub)
quickplot(asin(browsingpressure), data = browse_sub)

quickplot(browsingpressure, data = broadhouse9)
quickplot(browsingpressure, data = broadhouse10)

quickplot(log(beitetrykk + 1), data = browse_9)

quickplot(elgbROSprs9, data = browse_9)
quickplot(elgbFURUprs9, data = browse_9)
quickplot(elgbLAUVprs9, data = browse_9)
...
ggplot(browse9_dist2, aes(x = distvei1, y = beitetrykk)) +
            geom_point()+
