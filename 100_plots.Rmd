...
ggplot(data = browse9bro_dist, aes(log(beitetrykkr+1))) +
  geom_histogram(bins = 70)+
  theme_classic()

ggplot(data = browse9bro_dist, aes(beitetrykkr)) +
  geom_histogram(bins = 70)+
  theme_classic()

ggplot(data = browse9bro_dist, aes(skogkategori, beitetrykkr)) +
  geom_point()+
  theme_classic()

ggplot(data = browse9bro_dist, aes(distvei1)) +
  geom_histogram(bins = 70)+
  theme_classic()

ggplot(data = browse9bro, aes(disthus)) +
  geom_histogram(bins = 70)+
  theme_classic()

ggplot(data = browse9bro, aes(tretetthet)) +
  geom_histogram(bins = 70)+
  theme_classic()

test1 <- browse9bro_dist[which(browse9bro_dist$bt100 > 0),]

ggplot(data = test1, aes(sqrt(bt100))) +
  geom_bar()+
  theme_classic()


ggplot(data = browse9bro_disthus, aes(bt100)) +
  geom_histogram(bins = 70)+
  theme_classic()

ggplot(data = browse9bro_dist, aes(btbinary)) +
  geom_histogram(bins = 70)+
  theme_classic()
