...
fp1 <- ggplot(data = browse9.3, aes(beitetrykkr)) +
  geom_histogram(bins = 70)+
  theme_classic()

fp2 <- ggplot(data = browse9.3, aes(disthus)) +
  geom_histogram(bins = 70)+
  theme_classic()

fp3 <- ggplot(data = browse9.3, aes(distvei1)) +
  geom_histogram(bins = 70)+
  theme_classic()

fp4 <- ggplot(data = browse9.3, aes(distvei2)) +
  geom_histogram(bins = 70)+
  theme_classic()

fp5 <- ggplot(data = browse9.3, aes(distvei3)) +
  geom_histogram(bins = 70)+
  theme_classic()

fp6 <- ggplot(data = browse9.3, aes(skogkategori)) +
  geom_bar()+
  theme_classic()

fp7 <- ggplot(data = browse9.3, aes(kant)) +
  geom_bar()+
  theme_classic()

fp8 <- ggplot(data = browse9.3, aes(treartgruppe)) +
  geom_bar()+
  theme_classic()

fp9 <- ggplot(data = browse9.3, aes(helling)) +
  geom_histogram(bins = 70)+
  theme_classic()

fp10 <- ggplot(data = browse9.3, aes(HOH)) +
  geom_histogram(bins = 70)+
  theme_classic()

ggplot(data = browse9.3, aes(HOH^2)) +
  geom_histogram(bins = 70)+
  theme_classic()

fp11 <- ggplot(data = browse9.3, aes(region)) +
  geom_bar()+
  theme_classic()

fp12 <- ggplot(data = browse9.3, aes(tretetthet9)) +
  geom_bar()+
  theme_classic()

ggplot(data = browse9.3, aes(log(tretetthet9))) +
  geom_bar()+
  theme_classic()

ggplot(data = browse9.3, aes(tretetthet9^2)) +
  geom_bar()+
  theme_classic()

library(gridExtra)
grid.arrange(fp1, fp2, fp3, fp4, fp5, fp6, fp7, fp8, fp9, fp10, fp11, fp12, nrow = 6)
