...
# fp3 <- ggplot(data = browse9.2_dist, aes(distvei1)) +
#   geom_histogram(bins = 70)+
#   theme_classic()
...
# fp5 <- ggplot(data = browse9.2_dist, aes(distvei3)) +
#   geom_histogram(bins = 70)+
#   theme_classic()
...
fp12 <- ggplot(data = browse9.2_dist, aes(tretetthet9_trunc)) +
  geom_bar()+
  theme_classic()
...
fpb2 <- ggplot(data = browse9.2pos_dist, aes(disthus)) +
  geom_histogram(bins = 70)+
  theme_classic()
...
fpb4 <- ggplot(data = browse9.2pos_dist, aes(distvei2)) +
  geom_histogram(bins = 70)+
  theme_classic()
