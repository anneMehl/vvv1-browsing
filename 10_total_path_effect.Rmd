...
#### Recruitment ----
load("output/recruitment_2021_02_02/rec_h_bin2_600.rda")
zeromod2 <- rec_h_bin2_600
summary(zeromod2)

load("output/recruitment_2021_02_02/rec_h_beta3_TMB.rda")
percmod2 <- rec_h_beta3_TMB
summary(percmod2)
...
ggsave(file = "function_browse_hurdle_husvei.tiff", hurdle_husvei, width = 30, height = 15, units = "cm", dpi = 150) #, dpi = 150
...
ggsave(file = "function_browse_hurdle_grid.pdf", hurdle_grid, width = 30, height = 45, units = "cm") #, dpi = 150
...
ggsave(file = "function_total_direct_husvei.pdf", total_direct_husvei, width = 30, height = 15, units = "cm") #, dpi = 150
...
ggsave(file = "function_total_direct_grid.tiff", total_direct_grid, width = 30, height = 45, units = "cm", dpi = 150) #, dpi = 150
