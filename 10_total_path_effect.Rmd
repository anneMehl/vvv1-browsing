...
#### Recruitment ----
load("output/recruitment_07_12_2020/rec_h_bin7_600_test.rda")
zeromod2 <- rec_h_bin7_600_test
summary(zeromod2)

load("output/recruitment_07_12_2020/rec_h_beta7_TMB_test.rda")
percmod2 <- rec_h_beta7_TMB_test
summary(percmod2)
...
pdt_disthus <- ggplot() + 
  ...
  scale_linetype_manual("Effect on Recruitment",
  ...
  scale_color_manual(name = "Effect on Recruitment", 
                     values = cbPalette) +
...
pdt_skogkat <- ggplot() +
  ...
  theme(axis.text.x = element_text(size = 40, angle = 40, vjust = 1, hjust = 1), # face = "bold"
...
ph_treart <- ggplot(data = bp_treart,aes(var, point)) +
  geom_pointrange(aes(ymin = CI025, ymax = CI975), colour = "#0072B2", size = 1.5) +
  theme_light() +
  theme(axis.text.x = element_text(size = 50, angle = 35, vjust = 1, hjust = 1),
        axis.text.y = element_text(size = 50),
        axis.title = element_text(family = "sans", size = 50),
        legend.position = c(0.7, 0.9)) +
...
pdt_kant <- ggplot() +
  ...
  theme_light() +
  theme(axis.text.x = element_text(size = 50, angle = 35, vjust = 1, hjust = 1), # face = "bold"
        axis.text.y = element_text(size = 50),
        axis.title = element_text(family = "sans", size = 50),
        legend.position = c(0.85, 0.85),
        legend.text = element_text(size = 30),
...
ph_tretett <- ggplot() +
  ...
  theme_light() +
  theme(axis.text.x = element_text(size = 50, angle = 0, vjust = 1, hjust = 1), 
        axis.text.y = element_text(size = 50),
        axis.title = element_text(family = "sans", size = 50),
        legend.position = c(0.7, 0.9)) +
  xlab("Tree density\n") + 
