...
grid.arrange(bp_tretetthet, bp_distvei, bp_hell, bp_hoh, bp_kant, bp_skogkat, 
             bp_treart,
             nrow = 3, ncol = 3) 

grid.arrange(bp_disthus, bp_tretetthet, bp_distvei, bp_hell, bp_hoh, bp_kant, bp_skogkat, 
             bp_treart,
             nrow = 3, ncol = 3) # with disthus


grid.arrange(t_browse, t_distvei, t_hell, t_hoh, t_skogkat, 
             t_treart,
             nrow = 3, ncol = 3) 

grid.arrange(t_disthus,t_browse, t_distvei, t_hell, t_hoh, t_skogkat, 
             t_treart,
             nrow = 3, ncol = 3) # with disthus


grid.arrange(td_distvei, td_hell, td_kant, td_skogkat, td_treart, td_tretetthet, td_browse, td_hoh,
             nrow = 3, ncol = 3) 

grid.arrange(td_disthus,td_distvei, td_hell, td_kant, td_skogkat, td_treart, td_tretetthet, td_browse, td_hoh,
             nrow = 3, ncol = 3) # with disthus 
