...
## Data plots appendix ----
load("processdata/browse_incl_huskat_2021_04_15.rda")
load("processdata/recruits_incl_huskat_2021_04_15.rda")
names(browse)
names(recruits)
browse$disthuskat <- as.factor(browse$disthuskat)
recruits$disthuskat <- as.factor(recruits$disthuskat)

# library(sjlabelled)
# browse$kant_num <- as_numeric(browse$kant)
# recruits$kant_num <- as_numeric(recruits$kant)
...
b1 <- ggplot(browse, aes(disthuskat, fill = kant))  +
    geom_bar(position = position_fill(reverse = F)) +
  theme_classic() +
  xlab("Distance to house") + 
  guides(fill = guide_legend(title = "Edge"))+
  guides(x =  guide_axis(angle = 90))

b2 <- ggplot(browse, aes(disthuskat, helling))  + 
    stat_summary(fun = mean, geom = "col", position = "identity") + 
  theme_classic() +
  xlab("Distance to house") + 
  ylab("Slope (mean)") +
  guides(x =  guide_axis(angle = 90))

b3 <- ggplot(browse, aes(disthuskat, HOH))  + 
    stat_summary(fun = mean, geom = "col", position = "identity") + 
  theme_classic() +
  xlab("Distance to house") + 
  ylab("Altitude (mean)") +
...
b4 <- ggplot(browse, aes(disthuskat, tretetthet9, fill = treartgruppe9))  + 
    stat_summary(fun = mean, geom = "col", position = "stack") + 
  theme_classic() +
  xlab("Distance to house") + 
  ylab("Tree density (mean)") + 
  guides(fill = guide_legend(title = "Tree species\ngroup"))+
  guides(x =  guide_axis(angle = 90))

b5 <- ggplot(browse, aes(disthuskat, beitetrykk9, fill = treartgruppe9))  + 
    stat_summary(fun = mean, geom = "col", position = "stack") + 
  theme_classic() +
  xlab("Distance to house") + 
  ylab("Browsing pressure (mean)") + 
  guides(fill = guide_legend(title = "Tree species\ngroup"))+
  guides(x =  guide_axis(angle = 90))

b6 <- ggplot(browse, aes(disthuskat, fill = skogkategori))  +
    geom_bar(position = position_fill(reverse = F)) +
  theme_classic() +
  xlab("Distance to house") + 
  guides(fill = guide_legend(title = "Forest category"))+
  guides(x =  guide_axis(angle = 90))


library(gridExtra)
b_grid <- grid.arrange(b1, b2, b3, b4, b5, b6,
          nrow = 3, ncol = 2)

ggsave(file = "b_grid.tiff", b_grid, width = 30, height = 20, units = "cm", dpi = 150) #, dpi = 150


## recruits ----
r1 <- ggplot(recruits, aes(disthuskat, fill = kant))  +
    geom_bar(position = position_fill(reverse = F)) +
  theme_classic() +
  xlab("\nDistance to house") + 
  guides(fill = guide_legend(title = "Edge")) +
...
r2 <- ggplot(recruits, aes(disthuskat, helling))  + 
    stat_summary(fun = mean, geom = "col", position = "identity") + 
  theme_classic() +
  xlab("\nDistance to house") + 
  ylab("Slope (mean)") +
...
r3 <- ggplot(recruits, aes(disthuskat, HOH))  + 
    stat_summary(fun = mean, geom = "col", position = "identity") + 
  theme_classic() +
  xlab("\nDistance to house") + 
  ylab("Altitude (mean)") +
...
r4 <- ggplot(recruits, aes(disthuskat, tretetthet9, fill = treartgruppe9))  + 
    stat_summary(fun = mean, geom = "col", position = "stack") + 
  theme_classic() +
  xlab("\nDistance to house") + 
  ylab("Tree density (mean)") + 
...
r5 <- ggplot(recruits, aes(disthuskat, fill = skogkategori))  +
    geom_bar(position = position_fill(reverse = F)) +
  theme_classic() +
  xlab("\nDistance to house") + 
  guides(fill = guide_legend(title = "Forest category"))+
...
r6 <- ggplot(recruits, aes(disthuskat, recruitment))  + 
    stat_summary(fun = mean, geom = "col", position = "identity") + 
  theme_classic() +
  xlab("\nDistance to house") + 
  ylab("Recruitment (mean)") +
  guides(x =  guide_axis(angle = 90))

r7 <- ggplot(recruits, aes(disthuskat, recruitment, fill = treartgruppe9))  + 
    stat_summary(fun = mean, geom = "col", position = "stack") + 
  theme_classic() +
  xlab("\nDistance to house") + 
  ylab("Recruitment (mean)") + 
...
library(gridExtra)
r_grid <- grid.arrange(r1, r2, r3, r4, r5, r6, r7,
          nrow = 4, ncol = 2)

ggsave(file = "r_grid.tiff", r_grid, width = 30, height = 30, units = "cm", dpi = 150) #, dpi = 150
