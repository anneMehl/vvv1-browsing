...
zeromod2 <- rec_r_bin3
load("output/recruitment_07_12_2020/rec_r_bin3_test.rda")
zeromod2 <- rec_r_bin3_test

load("output/recruitment_07_12_2020/rec_r_beta5_TMB.rda")
percmod2 <- rec_r_beta5_TMB # Interaction moose_density*distvei2
load("output/recruitment_07_12_2020/rec_r_beta4_TMB_test.rda")
percmod2 <- rec_r_beta4_TMB_test
...
pdt_skogkat <- ggplot() +
  ...
  theme(axis.text.x = element_text(size = 40, angle = 30, vjust = 1, hjust = 1), # face = "bold"
