...
pdt_disthus <- ggplot() +
    ...
    geom_ribbon(data = total_disthus, aes(x = var, ymin = CI025, ymax = CI975), linetype = 0, alpha = 0.2, show.legend = F, fill = "#E69F00") +
...
ph_disthus <- ggplot() +
  geom_ribbon(data = bp_disthus, aes(x = var, ymin = CI025, ymax = CI975), show.legend = F, 
              fill = "#E69F00", linetype = 0, alpha = 0.2) + 
  geom_line(data = bp_disthus, aes(var, point),colour = "#E69F00", linetype = 1, size = 1.5)+
  theme_light() +
...
pdt_distvei <- ggplot() + 
  ...
  geom_ribbon(data = total_distvei, aes(x = var, ymin = CI025, ymax = CI975), 
              fill = "#E69F00", linetype = 0, alpha = 0.2, show.legend = F) +
...
ph_distvei <- ggplot() +
  geom_ribbon(data = bp_distvei, aes(x = var, ymin = CI025, ymax = CI975), show.legend = F, 
              fill = "#E69F00", linetype = 0, alpha = 0.2) + 
  geom_line(data = bp_distvei, aes(var, point),colour = "#E69F00", linetype = 1, size = 1.5)+
  theme_light() +
  theme(axis.text = element_text(size = 20),
        axis.title = element_text(family = "sans", size = 20),
        legend.position = c(0.7, 0.9),
...
ph_skogkat <- ggplot(data = bp_skogkat,aes(var, point)) +
  geom_pointrange(aes(ymin = CI025, ymax = CI975), colour = "#E69F00", size = 1.5) +
  theme_light() +
  theme(axis.text = element_text(size = 20),
        axis.title = element_text(family = "sans", size = 20),
        legend.position = c(0.7, 0.9),
...
pdt_hell <- ggplot() + 
  ...
  geom_ribbon(data = total_hell, aes(x = var, ymin = CI025, ymax = CI975), fill = "#E69F00", linetype = 0, alpha = 0.2, show.legend = F) +
...
ph_hell <- ggplot() +
  geom_ribbon(data = bp_hell, aes(x = var, ymin = CI025, ymax = CI975), show.legend = F, 
              fill = "#E69F00", linetype = 0, alpha = 0.2) + 
  geom_line(data = bp_hell, aes(var, point),colour = "#E69F00", linetype = 1, size = 1.5)+
  theme_light() +
  theme(axis.text = element_text(size = 20),
        axis.title = element_text(family = "sans", size = 20),
        legend.position = c(0.7, 0.9),
...
pdt_hoh <- ggplot() + 
  ...
  geom_ribbon(data = total_HOH, aes(x = var, ymin = CI025, ymax = CI975), fill = "#E69F00", linetype = 0, alpha = 0.2, show.legend = F) +
...
ph_hoh <- ggplot() +
  geom_ribbon(data = bp_hoh, aes(x = var, ymin = CI025, ymax = CI975), show.legend = F, 
              fill = "#E69F00", linetype = 0, alpha = 0.2) + 
  geom_line(data = bp_hoh, aes(var, point),colour = "#E69F00", linetype = 1, size = 1.5)+
  theme_light() +
  theme(axis.text = element_text(size = 20),
        axis.title = element_text(family = "sans", size = 20),
        legend.position = c(0.7, 0.9),
...
# tretett ----
pdt_tretett <- ggplot() + 
  geom_ribbon(data = total_tretett, aes(x = var, ymin = CI025, ymax = CI975), fill = "#E69F00", linetype = 0, alpha = 0.2, show.legend = F) +
...
ph_tretett <- ggplot() +
  geom_ribbon(data = bp_tretett, aes(x = var, ymin = CI025, ymax = CI975), show.legend = F, 
              fill = "#E69F00", linetype = 0, alpha = 0.2) + 
  geom_line(data = bp_tretett, aes(var, point),colour = "#E69F00", linetype = 1, size = 1.5)+
  theme_light() +
  theme(axis.text = element_text(size = 20),
        axis.title = element_text(family = "sans", size = 20),
        legend.position = c(0.7, 0.9),
...
# rest
grid.arrange(ph_treart, ph_hell, ph_hoh, ph_kant, ph_skogkat,  ph_tretett,
          nrow = 3, ncol = 2)
