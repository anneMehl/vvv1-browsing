...
browse_house <- browse_house[ ,-c(4,8,16:20,22)]
# Scale
...
attributes(recruits_house$HOH) # $`scaled:center` 365.9363 $`scaled:scale` 245.9447
attributes(recruits_house$moose_density) # $`scaled:center` 180.4643 $`scaled:scale` 193.7676
recruits_beitetrykk$var <- recruits_beitetrykk$var * 30.96057 + 25.79263
recruits_helling$var <- recruits_helling$var * 20.08128 + 19.68501
recruits_HOH$var <- recruits_HOH$var * 245.9447 + 365.9363
recruits_moose_density$var <- recruits_moose_density$var * 193.7676 + 180.4643

recruits_distvei$var <- exp(recruits_distvei$var)-1
