...
```{r}
(focal = c("distvei2", "skogkategori", "treartgruppe9", "kant", 
           "helling", "HOH", "tretetthet9", "beitetrykk9", "disthus", "moose_density")[7])
...
#### Save function data!
```{r}
save(bp_disthus, file = "output/function_results_08_12_2020/bp_disthus.rda")
```
...
# Browsing pressure (indirect)
load("output/function_results_08_12_2020/bp_disthus.rda")
load("output/function_results_08_12_2020/bp_distvei.rda")
load("output/function_results_08_12_2020/bp_skogkat.rda")
load("output/function_results_08_12_2020/bp_kant.rda")
load("output/function_results_08_12_2020/bp_treart.rda")
load("output/function_results_08_12_2020/bp_hell.rda")
load("output/function_results_08_12_2020/bp_hoh.rda")
load("output/function_results_08_12_2020/bp_tretett.rda")
...
### Roads
attributes(browse_house$beitetrykk9) # $`scaled:center` 25.79263 $`scaled:scale` 30.96057
attributes(browse_house$helling) # $`scaled:center` 19.68501 $`scaled:scale` 20.08128
attributes(browse_house$HOH) # $`scaled:center` 365.9363 $`scaled:scale` 245.9447
attributes(browse_house$moose_density) # $`scaled:center` 180.4643 $`scaled:scale` 193.7676
attributes(browse_house$tretetthet9) # $`scaled:center` 180.4643 $`scaled:scale` 193.7676
bp_beitetrykk$var <- bp_beitetrykk$var * 30.96057 + 25.79263
bp_helling$var <- bp_helling$var * 20.08128 + 19.68501
bp_HOH$var <- bp_HOH$var * 245.9447 + 365.9363
bp_moose_density$var <- bp_moose_density$var * 193.7676 + 180.4643
...
### Roads
attributes(recruits_house$beitetrykk9) # $`scaled:center` 25.79263 $`scaled:scale` 30.96057
...
attributes(recruits_house$moose_density) # $`scaled:center` 180.4643 $`scaled:scale` 193.7676
recruit_beitetrykk$var <- recruit_beitetrykk$var * 30.96057 + 25.79263
recruit_helling$var <- recruit_helling$var * 20.08128 + 19.68501
recruit_HOH$var <- recruit_HOH$var * 245.9447 + 365.9363
recruit_moose_density$var <- recruit_moose_density$var * 193.7676 + 180.4643

recruit_distvei$var <- exp(recruits_distvei$var)-1
...
total_helling$var <- total_helling$var * 20.08128 + 19.68501
...
pdt_disthus <- ggplot() +
  ...
  scale_linetype_manual("Recruitment",
  ...
  scale_color_manual(name = "Recruitment", 
                     values = cbPalette) +
