...
save(recruit_moose, file = "output/function_results_2021_02_03/recruit_moose.rda")
...
# 
pd_disthus <- ggplot() +
  geom_line(data = recruit_int_min, aes(var, point), colour = "red", linetype = 1, size = 1, show.legend = T) +
  geom_ribbon(data = recruit_int_min, aes(x = var, ymin = CI025, ymax = CI975), colour = "red", linetype = 2, alpha = 0.2) +
  geom_line(data = recruit_int_max, aes(var, point), colour = "blue", linetype = 1, size = 1, show.legend = T) +
  geom_ribbon(data = recruit_int_max, aes(x = var, ymin = CI025, ymax = CI975), colour = "blue", linetype = 2, alpha = 0.2) +
  xlab("\nDistance to house (m)") +
  ylab("Recruitment (ha 10yr)\n") +
  theme_light()+
  theme(axis.text = element_text(size = 10),
...
nullplot <- ggplot()+
  theme_void()
total_direct_husvei <- ggarrange(nullplot, pdt_disthus, 
          ncol = 1,
          nrow = 2,
          heights = c(0.1,1),
          label.args = list(gp = gpar(font = 2, fontsize = 15), x = unit(1,"line"), hjust = -1, vjust = 0),
...
ggsave(file = "figs_tabs/total_direct_function/2021_03_03/function_total_direct_hus.pdf", total_direct_husvei, width = 15, height = 15, units = "cm") #, dpi = 150
