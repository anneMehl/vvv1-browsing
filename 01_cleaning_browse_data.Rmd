...
browse9.2_dist$veitype2 <- as.factor(browse9.2_dist$veitype2)
...
browse9.2$disthus_tr
browse9.2$distvei2_trunc <- ifelse(browse9.2$distvei2 >= 3000, 3000, browse9.2$distvei2)
