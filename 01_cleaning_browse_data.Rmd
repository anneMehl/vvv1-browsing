...
browse_9 <- browse_9[,c(1:8,10:18,26:28,32:39,41:46,48:52,58:61,68:74,79:82)]

browse9bro <- browse_9[,c(1:8, 28, 35, 40:54)] # for browsing pressure response
...
browse91_dist <- browse_91[which(browse_91$distvei1 < 1501 & browse_91$disthus > 499), ] # longest distance to any road (that is further than 500m from a house) 1500m
...
# browse9bro_dist$bt100[browse9bro_dist$bt100 > 0.90] <- 1.00
browse9bro_dist$bt100[browse9bro_dist$bt100 == 0.00] <- 0.01
