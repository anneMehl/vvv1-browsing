...
p1 <- ggplot(data = coefm13,aes(term, estimate)) +
  geom_line(colour = "#009292", linetype = 1, size = 1)+
  geom_ribbon(aes(ymin = lower.CL, ymax = upper.CL), colour = "#004949", linetype = 2, alpha = 0.2) +
  theme_light() +
...
p1 <- plot_model(m13, type = c("eff"), terms = c("log_distvei2_trunc [exp]"),
                 colors = "#004949", title = "", line.size = 1, log.y = F)
p1 + theme_light() +
...
get_model_data(m13, type = "eff",  terms = "skogkategori",  pred.type = "fe")
