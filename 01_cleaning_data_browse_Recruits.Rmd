...
```{r}
recruits <- browse0.1[, c(1,3,5,7:9,27:29,31:45,74,76:83,88,90,103,105,112:117)]
str(recruits)
names(recruits)

recruits <- recruits[, -c(7:9,22:24, 26:33)]
str(recruits)
names(recruits)
...
```{r}
recruits_test_910 <- split(recruits_test, recruits_test$takst)

recruits9 <- recruits_test_910[['9']]
summary(recruits9)

recruits10 <- recruits_test_910[['10']]
summary(recruits10)
str(recruits10$treartgruppe10)

recruits9$FLATEID <- as.factor(recruits9$FLATEID)
str(levels(recruits9$FLATEID))
# unique(recruits9$FLATEID)
# 
recruits10$FLATEID <- as.factor(recruits10$FLATEID)
str(levels(recruits10$FLATEID))
# unique(recruits10$FLATEID)

recruits9_test <- recruits9 %>% distinct(FLATEID, .keep_all= TRUE)
recruits10_test <- recruits10 %>% distinct(FLATEID, .keep_all= TRUE)

recruits_distinct <- full_join(recruits10_test, recruits9_test, by = "FLATEID")
str(levels(recruits$FLATEID))



## 9th cycle
# recruits9m$proplt1 <- ifelse(recruits9m$treartgruppe9 == "FURU", (recruits9m$Furu_0_25_PRHA + recruits9m$Furu_25_49_PRHA)/(recruits9m$Furu_0_PRHA + recruits9m$Furu_0_25_PRHA + recruits9m$Furu_25_49_PRHA), (recruits9m$Lauv_0_25_PRHA + recruits9m$Lauv_25_49_PRHA)/ (recruits9m$Lauv_0_PRHA + recruits9m$Lauv_0_25_PRHA + recruits9m$Lauv_25_49_PRHA))
# 
# str(recruits9m$proplt1)
# sum(recruits9m$proplt1, na.rm = T)
# mean(recruits9m$proplt1, na.rm = T)


## 10th cycle
# recruits10m$proplt1 <- ifelse(recruits10m$treartgruppe10 == "FURU", (recruits10m$Furu_0_25_PRHA + recruits10m$Furu_25_49_PRHA)/(recruits10m$Furu_0_PRHA + recruits10m$Furu_0_25_PRHA + recruits10m$Furu_25_49_PRHA), (recruits10m$Lauv_0_25_PRHA + recruits10m$Lauv_25_49_PRHA)/ (recruits10m$Lauv_0_PRHA + recruits10m$Lauv_0_25_PRHA + recruits10m$Lauv_25_49_PRHA))
# 
# str(recruits10m$proplt1)
# sum(recruits10m$proplt1, na.rm = T)
# mean(recruits10m$proplt1, na.rm = T)
# 
# 
# recruits_test$FLATEID <- as.factor(recruits_test$FLATEID)
# str(levels(recruits_test$FLATEID))
...
# recruits$proplt2 <- ifelse(recruits$treartgruppe10.x == "FURU" | recruits$treartgruppe9.y == "FURU", 
#                                 recruits$Furu_0_25_PRHA.x/recruits$Furu_0_PRHA.y, 
#                                 recruits$Lauv_0_25_PRHA.x/recruits$Lauv_0_PRHA.y)
...
recruits$proplt2 <- ifelse(recruits$treartgruppe10 == "FURU" | recruits$treartgruppe9 == "FURU", 
                                ...
                                (recruits$Lauv_0_25_PRHA + recruits$Bjork_0_25_PRHA)/recruits$Lauv_0_PRHA)
str(recruits$proplt2)
...
# recruits$proplt3 <- ifelse(recruits$treartgruppe10.x == "FURU" | recruits$treartgruppe9.y == "FURU", 
#                                 recruits$Furu_25_49_PRHA.x/recruits$Furu_0_PRHA.y, 
#                                 recruits$Lauv_25_49_PRHA.x/recruits$Lauv_0_PRHA.y)
...
recruits$proplt3 <- ifelse(recruits$treartgruppe10 == "FURU" | recruits$treartgruppe9 == "FURU", 
                                ...
                                (recruits$Lauv_25_49_PRHA + recruits$Bjork_0_25_PRHA)/recruits$Lauv_0_PRHA)
