...
# 9th and 10th
recruits_test$proplt2 <- (recruits_test$Furu_0_25_PRHA.y + recruits_test$Lauv_0_25_PRHA.y)/(recruits_test$Furu_0_PRHA.x + recruits_test$Lauv_0_PRHA.x)
str(recruits_test$proplt2)

# 9th
recruits_test$proplt <- (recruits_test$Furu_0_25_PRHA.x + recruits_test$Lauv_0_25_PRHA.x)/(recruits_test$Furu_0_PRHA.x + recruits_test$Lauv_0_PRHA.x)
str(recruits_test$proplt)


recruits_cor <- recruits_test[, c(98:99)]
str(recruits_cor)
nrow(recruits_cor)
nrow(na.omit(recruits_cor))
recruits_cor <- na.omit(recruits_cor)

cor(recruits_cor)
cor.test(recruits_cor$proplt2, recruits_cor$proplt)
