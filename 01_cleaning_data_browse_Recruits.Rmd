...
```{r}
recruits_test <- browse0.1[, c(1,3,5,7:9,27:29,31:45,74,76:83,88,90,103,105,112:117)]
str(recruits_test)
names(recruits_test)

recruits_test <- recruits_test[, -c(7:12,16:18,22:24)]
...
# = 0.2254849
recruits_test$proplt2 <- ifelse(recruits10m$treartgruppe10 == "FURU", (recruits10m$Furu_0_25_PRHA + recruits10m$Furu_25_49_PRHA)/(recruits10m$Furu_0_PRHA + recruits10m$Furu_0_25_PRHA + recruits10m$Furu_25_49_PRHA), (recruits10m$Lauv_0_25_PRHA + recruits10m$Lauv_25_49_PRHA)/ (recruits10m$Lauv_0_PRHA + recruits10m$Lauv_0_25_PRHA + recruits10m$Lauv_25_49_PRHA))
