...
# = 0.2254849
sum((recruits10$Furu_0_25_PRHA + recruits10$Furu_0_25_PRHA),na.rm=TRUE)/sum(recruits9$Furu_0_PRHA,na.rm=TRUE) # pool lauv and bjork for 10th takst, because they are pooled in 9th takst?
# = 0.4509698
...
# = 0.1192973
sum((recruits10$Furu_25_49_PRHA + recruits10$Furu_25_49_PRHA),na.rm=TRUE)/sum(recruits9$Furu_0_PRHA,na.rm=TRUE)
# = 0.2385945
...
#### With trees above 5 cm DBH
```{r}
# Number of trees 2(10)/ number of trees 1(9)
sum(recruits10$Furu_25_49_PRHA,na.rm=TRUE)/sum(recruits9$Furu_0_25_PRHA,na.rm=TRUE)
# = 0.7969221
sum((recruits10$Lauv_25_49_PRHA + recruits10$Bjork_25_49_PRHA),na.rm=TRUE)/sum(recruits9$Lauv_0_25_PRHA,na.rm=TRUE) # pool lauv and bjork for 10th takst, because they are pooled in 9th takst?
# = 0.3416208


# Number of trees 3(10)/ number of trees 1(9)
sum(recruits10$FURU_50_PRHA,na.rm=TRUE)/sum(recruits9$Furu_0_25_PRHA,na.rm=TRUE)
# = 4.061618
sum((recruits10$LAUV_50_PRHA + recruits10$BJORK_50_PRHA),na.rm=TRUE)/sum(recruits9$Lauv_0_25_PRHA,na.rm=TRUE)
# = 0.4100393


# Number of trees 3(10)/ number of trees 2(9)
sum(recruits10$FURU_50_PRHA,na.rm=TRUE)/sum(recruits9$Furu_25_49_PRHA,na.rm=TRUE)
# = 6.686168
sum((recruits10$LAUV_50_PRHA + recruits10$BJORK_50_PRHA),na.rm=TRUE)/sum(recruits9$Furu_25_49_PRHA,na.rm=TRUE)
# = 20.38058
