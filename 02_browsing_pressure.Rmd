...
gam14 <- gam(beitetrykkr ~ distvei1 + disthus+ skogkategori + treartgruppe + region + kant + helling + hohkatb + tretetthet, data = browse9bro_dist, method = "REML")
```
...
# candidates
AIC(m10alm, m10blm, m10clm, m9aglm, m9bglm, m9cglm, m10aglm, m11glm, m11aglm, m8glm, h2b, z3a)
