...
m1jbin2 <- glmer(factor(beitetrykkr > 0) ~ disthus_trunc_cut200_scale + log(distvei2+1) + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet9_trunc_scale + (1|KOMNR),
            family = binomial(),
            data = browse9.2) 
...
m1lbin2 <- glmer(factor(beitetrykkr > 0) ~ disthus_trunc_cut175_scale + log(distvei2+1) + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet9_trunc_scale + (1|KOMNR),
            family = binomial(),
            data = browse9.2)
...
Candmods_bin <- list(m1abin, m1gbin, m1hbin, m1ibin, m1jbin, m1kbin, m1lbin)
...
```{r}
save(m2bin, file = "output/recentBP_selection/m2bin.rda")
save(m3bin, file = "output/recentBP_selection/m3bin.rda")
save(m4bin, file = "output/recentBP_selection/m4bin.rda")
...
```{r}
AIC(m1gbeta, m1hbeta, m1ibeta, m1jbeta, m1kbeta, m1lbeta)
# cut200 is the thing!
