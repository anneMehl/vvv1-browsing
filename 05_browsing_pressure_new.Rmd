...
# m2bin <- glmer(factor(beitetrykkr > 0) ~ disthus_cut175_scale + distvei2_trunc_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet9_trunc_scale + skogkategori*distvei2_trunc_scale + (1|KOMNR),
#             family = binomial(),
#             data = browse9.2_dist)

# m3bin <- glmer(factor(beitetrykkr > 0) ~ disthus_scale + distvei2_trunc_scale + (1|KOMNR),
#             family = binomial(),
#             data = browse9.2_dist)

m4bin <- glmer(factor(beitetrykkr > 0) ~ disthus_trunc_scale + distvei2_trunc_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet9_trunc_scale + skogkategori*distvei2_trunc_scale + (1|KOMNR),
            family = binomial(),
...
resid.m6bin <- resid(m6bin)
plot(resid.m6bin)

par(mfrow = c(2,3))
plot(resid.m6bin ~ skogkategori, data = browse9.2_dist)
plot(resid.m6bin ~ treartgruppe, data = browse9.2_dist)
plot(resid.m6bin ~ kant, data = browse9.2_dist)
plot(resid.m6bin ~ helling_scale, data = browse9.2_dist)
plot(resid.m6bin ~ HOH_scale, data = browse9.2_dist)
plot(resid.m6bin ~ tretetthet9_trunc_scale, data = browse9.2_dist)

library(sjPlot)
plot_model(m6bin, type = c("diag"), transform, terms = NULL)
...
library(gridExtra)
plot_grid(list(p1, p2, p3, p4, p5, p6, p7, p8))
...
m7beta <- glmmTMB(bt100 ~ disthus_scale + distvei2_trunc_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet9_trunc_scale + (1|KOMNR),
            data = browse9.2pos_dist,
            family = beta_family())
...
m9beta <- glmmTMB(bt100 ~ disthus_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet9_trunc_scale + (1|KOMNR),
            data = browse9.2pos_dist,
            family = beta_family())
