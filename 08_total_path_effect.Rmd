...
resp_curve <- function(focal, isfactor=FALSE, dat, treedat, zeromod, percmod, treemod, which_effect=c("direct")[2], nvals=100, plot=T, nb_btstrp=999){
  treefocal <- focal
...
# Hurdle only
hurdle_disthus <- resp_curve("disthus_trunc_cut200_scale", isfactor=F, dat=browse9.4_house, treedat=browse9.4_house,zeromod=m1kbin2, percmod=m1ibeta2, treemod=mhus2, which_effect="hurdle_only", nvals=100, plot=F, nb_btstrp=999)
...
# total
total_disthus <- resp_curve("disthus_trunc_cut200_scale", isfactor=F, dat=browse9.4_house, treedat=browse9.4_house,zeromod=m1kbin2, percmod=m1ibeta2, treemod=mhus2, which_effect="total", nvals=100, plot=F, nb_btstrp=999)
...
## load function data
```{r}
load("output/hurdle_disthus.rda")
...
hurdle_disthus$var <- hurdle_disthus$var * 27.71453 + 192.2636
save(hurdle_disthus, file = "hurdle_disthus.rda")
...
ph_disthus <- ggplot(data = hurdle_disthus, aes(var, point)) +
