...
browse9.5m_region <- browse9.5m[,c(1:3,7,14:20,25:26,33,40)]
save(browse9.5m_region, file = "browse9.5m_region.rda")

# Subset on different cuts for disthus
browse9.6_region <- browse9.5m_region[ which(browse9.5m_region$disthus > 400), ]
save(browse9.6_region, file = "browse9.6_region.rda")
