...
```{r}
names(recruits_house)
recruits_house_bin <- recruits_house[, -c(13,16,18:22)]
...
family = poisson(),
data = recruits_house_beta) # NaNs produced
...
plot(allEffects(rec_h_beta4))
plot(effect("skogkategori", rec_h_beta4))
...
```{r}
save(rec_h_beta4, file = "rec_h_beta4.rda")
```
