...
# Mod3 19 22793.06      0.00  0.47   0.47 -11377.53
# Mod2 19 22793.12      0.06  0.46   0.93 -11377.56
# Mod4 19 22796.99      3.92  0.07   1.00 -11379.49
# Mod5 19 22803.35     10.29  0.00   1.00 -11382.67
# Mod6 19 22811.26     18.20  0.00   1.00 -11386.63
# Mod7 19 22825.85     32.78  0.00   1.00 -11393.92
# Mod8 19 22840.39     47.33  0.00   1.00 -11401.20
# Mod1 19 22866.51     73.45  0.00   1.00 -11414.26
...
family = binomial(),
data = recruits_house) # BEST; Same as rec_h_bin7, only run with disthus_600, so that both recruits house models have the same disthus variables - easier in the function
...
candmods_rec_house_bin <- list(rec_h_bin1, rec_h_bin2, rec_h_bin3, rec_h_bin4, rec_h_bin5, rec_h_bin6, rec_h_bin7)
...
# 
#       K      AIC Delta_AIC AICWt Cum.Wt        LL
# Mod7 19 22754.20      0.00  0.59   0.59 -11358.10
# Mod5 19 22754.94      0.73  0.41   1.00 -11358.47
# Mod1 19 22793.06     38.86  0.00   1.00 -11377.53
# Mod6 19 22794.61     40.40  0.00   1.00 -11378.30
# Mod4 18 22796.85     42.64  0.00   1.00 -11380.42
# Mod2 18 22802.42     48.22  0.00   1.00 -11383.21
# Mod3 17 22922.19    167.98  0.00   1.00 -11444.09
```
...
```{r}
library(sjPlot)
plot_model(rec_h_bin7_600, type = "diag")
plot_model(rec_h_bin7_600, type = "eff")
plot_model(rec_h_bin7_600, type = "est")
...
tab_model(rec_h_bin7_600, transform = NULL,
...
# 
#       K     AIC Delta_AIC AICWt Cum.Wt        LL
# Mod2 19 1145905      0.00     1      1 -572933.7
# Mod3 19 1145926     20.58     0      1 -572944.0
# Mod4 19 1147153   1247.53     0      1 -573557.5
# Mod5 19 1147951   2045.78     0      1 -573956.6
# Mod6 19 1148914   3008.85     0      1 -574438.1
# Mod7 19 1150628   4722.15     0      1 -575294.8
# Mod8 19 1150812   4906.27     0      1 -575386.8
# Mod1 19 1153296   7390.73     0      1 -576629.1
...
rec_h_beta7_TMB <- glmmTMB(recruitment ~ disthus_600 + log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) +  ac + (1|KOMNR),
                           family = poisson,
                           data = recruits_house) # BEST; Same as rec_h_beta7, just run with glmmTMB
summary(rec_h_beta7_TMB)
save(rec_h_beta7_TMB, file = "output/recruitment_07_12_2020/rec_h_beta7_TMB.rda")
...
candmods_rec_house_beta <- list(rec_h_beta1, rec_h_beta2, rec_h_beta3, rec_h_beta4, rec_h_beta5, rec_h_beta6, rec_h_beta7)
...
# 
#       K     AIC Delta_AIC AICWt Cum.Wt        LL
# Mod7 18 1143746      0.00     1      1 -571855.0
# Mod5 18 1144492    745.57     0      1 -572227.8
# Mod4 18 1145904   2157.79     0      1 -572933.9
# Mod1 19 1145905   2159.36     0      1 -572933.7
# Mod6 18 1146435   2689.24     0      1 -573199.6
...
```{r}
library(sjPlot)
plot_model(rec_h_beta7_TMB, type = "diag")
plot_model(rec_h_beta7_TMB, type = "eff")
plot_model(rec_h_beta7_TMB, type = "est")

library(performance)
# check_model(rec_h_beta7_TMB)
model_performance(rec_h_beta7_TMB)

tab_model(rec_h_beta7_TMB, transform = NULL,
          show.intercept = TRUE, show.est = TRUE, show.ci = 0.95, p.threshold = c(0.05, 0.01, 0.001))
...
save(rec_r_bin3, file = "output/recruitment_07_12_2020/rec_r_bin3.rda")
...
# Mod2 17 13856.77      16.75      0      1 -6911.36
...
library(glmmTMB)
rec_r_beta4_TMB <- glmmTMB(recruitment ~ log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) +  ac + (1|KOMNR),
                           family = poisson,
                           data = recruits_roads) # BEST; Same as rec_r_beta4, just run with glmmTMB
summary(rec_r_beta4_TMB)
save(rec_r_beta4_TMB, file = "output/recruitment_07_12_2020/rec_r_beta4_TMB.rda")
...
# 
#       K      AIC Delta_AIC AICWt Cum.Wt        LL
# Mod4 17 483630.0      0.00     1      1 -241798.0
# Mod1 18 484607.8    977.74     0      1 -242285.9
# Mod2 17 484608.1    978.08     0      1 -242287.0
# Mod3 16 485369.9   1739.89     0      1 -242669.0
...
library(sjPlot)
plot_model(rec_r_beta4_TMB, type = "diag")
plot_model(rec_r_beta4_TMB, type = "eff") 
plot_model(rec_r_beta4_TMB, type = "est")

tab_model(rec_r_beta4_TMB, transform = NULL,
          show.intercept = TRUE, show.est = TRUE, show.ci = 0.95, p.threshold = c(0.05, 0.01, 0.001))
...
```{r}
save(rec_r_beta4_TMB, file = "rec_r_beta4_TMB.rda")
```
...
p_rec_bin1_house <- plot_model(rec_h_bin7_600, type = c("eff"), transform = NULL, terms = c("disthus_600"))
...
p_rec_beta1_house <- plot_model(rec_h_beta7_TMB, type = c("eff"), transform = NULL, terms = c("disthus_600"))
...
p_rec_beta1 <- plot_model(rec_r_beta4_TMB, type = c("eff"), transform = NULL, terms = c("distvei2  [0:500]"))
...
p_rec_beta2 <- plot_model(rec_r_beta4_TMB, type = c("eff"), transform = NULL, terms = c("skogkategori"))
...
p_rec_beta3 <- plot_model(rec_r_beta4_TMB, type = c("eff"), transform = NULL, terms = c("treartgruppe9"))
...
p_rec_beta4 <- plot_model(rec_r_beta4_TMB, type = c("eff"), transform = NULL, terms = c("kant"))
...
p_rec_beta5 <- plot_model(rec_r_beta4_TMB, type = c("eff"), transform = NULL, terms = c("helling [all]"))
...
p_rec_beta6 <- plot_model(rec_r_beta4_TMB, type = c("eff"), transform = NULL, terms = c("HOH [all]"))
...
p_rec_beta7 <- plot_model(rec_r_beta4_TMB, type = c("eff"), transform = NULL, terms = c("beitetrykk9 [all]"))
