...
rec_h_bin7_600_test <- glmer(recruitment_bin ~ disthus_600 + log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) + moose_density +  ac + (1|KOMNR),
family = binomial(),
data = recruits_house)


save(rec_h_bin7_600, file = "output/recruitment_07_12_2020/rec_h_bin7_600.rda")
save(rec_h_bin7_600_test, file = "output/recruitment_07_12_2020/rec_h_bin7_600_test.rda")
```
...
rec_h_beta7_TMB_test <- glmmTMB(recruitment ~ disthus_600 + log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) +  ac + (1|KOMNR),
                           family = poisson,
                           data = recruits_house)
summary(rec_h_beta7_TMB_test)
save(rec_h_beta7_TMB_test, file = "output/recruitment_07_12_2020/rec_h_beta7_TMB_test.rda")
```
...
rec_r_bin3_test  <- glmer(recruitment_bin ~ log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) + moose_density +  ac + (1|KOMNR),
family = binomial(),
data = recruits_roads)
save(rec_r_bin3_test, file = "output/recruitment_07_12_2020/rec_r_bin3_test.rda")
...
rec_r_beta4_TMB <- glmmTMB(recruitment ~ log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) +  ac + (1|KOMNR),
                           family = poisson,
                           data = recruits_roads) # Same as rec_r_beta4, just run with glmmTMB
summary(rec_r_beta4_TMB)
save(rec_r_beta4_TMB, file = "rec_r_beta4_TMB.rda")

rec_r_beta4_TMB_test <- glmmTMB(recruitment ~ log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) +  ac + (1|KOMNR),
                           family = poisson,
                           data = recruits_roads) # Very big difference in estimates when beitetrykk is not scaled
save(rec_r_beta4_TMB_test, file = "rec_r_beta4_TMB_test.rda")
...
model_performance(rec_r_beta5_TMB)
