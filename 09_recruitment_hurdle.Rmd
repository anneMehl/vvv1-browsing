...
rec_r_bin4  <- glmer(recruitment_bin ~ moose_density*log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) +  ac + (1|KOMNR),
family = binomial(),
data = recruits_roads)
...
rec_r_beta5_TMB <- glmmTMB(recruitment ~ moose_density*log(distvei2+1) + skogkategori + treartgruppe9 + beitetrykk9 + kant + helling + HOH + I(HOH^2) +  ac + (1|KOMNR),
                           family = poisson,
                           data = recruits_roads) # BEST
# Warning messages:
# 1: In (function (start, objective, gradient = NULL, hessian = NULL,  :
#   NA/NaN function evaluation
summary(rec_r_beta5_TMB)
save(rec_r_beta5_TMB, file = "rec_r_beta5_TMB.rda")
...
candmods_rec_roads_beta <- list(rec_r_beta4_TMB, rec_r_beta5_TMB)
...
#       K     AICc Delta_AICc AICcWt Cum.Wt        LL
# Mod2 19 483585.9        0.0      1      1 -241773.9
# Mod1 17 483630.2       44.3      0      1 -241798.0
```
...
load("processdata/recruits_roads.rda")
str(recruits_roads)
load("output/recruitment_07_12_2020/rec_r_beta5_TMB.rda")
summary(rec_r_beta5_TMB)
