...
m1glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + distvei1_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet_scale + skogkategori*distvei1_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)

m2glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + distvei1_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)
...
m6glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)

m7glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + distvei1_scale +  treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)

m8glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + treartgruppe*tretetthet_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)

m9glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + distvei1_scale + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + treartgruppe*tretetthet_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)

m10glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + distvei1_scale + skogkategori + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + treartgruppe*tretetthet_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)

m11glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + treartgruppe + skogkategori + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + distvei1_scale*tretetthet_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)
...
library(gridExtra)
plot_grid(list(p2, p3, p4, p5, p6, p7))
...
m3glmmbeta <- glmmTMB(bt100 ~ disthus_cut210_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet_scale + skogkategori*distvei1_scale + (1|KOMNR),
                    data = browse_9_distsub,
                    family = beta_family())
...
Candmods_bin <- list(m1glmmbeta, m2glmmbeta, m3glmmbeta)


glmmbin_tab <- aictab(Candmods_bin, modnames = NULL,
                       second.ord = FALSE, nobs = NULL, sort = TRUE)

# AIC/ coef table?? -> try sjPlot!!!!
```

```{r}
pb1 <- plot_model(m3glmmbeta, type = c("eff"), transform = NULL, terms = c("disthus_cut210_scale [all]"))
pb1 + theme_sjplot()

pb2 <- plot_model(m3glmmbeta, type = c("eff"), transform = NULL, terms = c("skogkategori"))
pb2 + theme_sjplot()

pb3 <- plot_model(m3glmmbeta, type = c("eff"), transform = NULL, terms = c("treartgruppe"))
pb3 + theme_sjplot()

pb4 <- plot_model(m3glmmbeta, type = c("eff"), transform = NULL, terms = c("kant"))
pb4 + theme_sjplot()

pb5 <- plot_model(m3glmmbeta, type = c("eff"), transform = NULL, terms = c("helling_scale [all]"))
pb5 + theme_sjplot()

pb6 <- plot_model(m3glmmbeta, type = c("eff"), transform = NULL, terms = c("HOH_scale [all]"))
pb6 + theme_sjplot()

pb7 <- plot_model(m3glmmbeta, type = c("eff"), transform = NULL, terms = c("tretetthet_scale [all]"))
pb7 + theme_sjplot()

plot_grid(list(pb1, pb2, pb3, pb4, pb5, pb6, pb7))
