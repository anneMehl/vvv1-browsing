...
m1abeta <- betareg(bt100 ~ distvei1 + disthus + skogkategori + treartgruppe + ac + kant + helling + hohkatb + tretetthet + skogkategori*distvei1,
            data = browse9bro_dist,
            subset = beitetrykkr > 0) # nbs (in ac) = 10000

m1bbeta <- betareg(bt100 ~ distvei1 + disthus + skogkategori + treartgruppe + ac + kant + helling + hohkatb + tretetthet + skogkategori*distvei1,
            data = browse9bro_dist,
            subset = beitetrykkr > 0) # nbs (in ac) = 26000

m1cbeta <- betareg(bt100 ~ distvei1 + disthus + skogkategori + treartgruppe + ac + kant + helling + hohkatb + tretetthet + skogkategori*distvei1,
            data = browse9bro_dist,
            subset = beitetrykkr > 0) # nbs (in ac) = 35000

m1dbeta <- betareg(bt100 ~ distvei1 + disthus + skogkategori + treartgruppe + ac + kant + helling + hohkatb + tretetthet + skogkategori*distvei1,
            data = browse9bro_dist,
            subset = beitetrykkr > 0) # nbs (in ac) = 55000

m1ebeta <- betareg(bt100 ~ distvei1 + disthus + skogkategori + treartgruppe + ac + kant + helling + hohkatb + tretetthet + skogkategori*distvei1,
            data = browse9bro_dist,
            subset = beitetrykkr > 0) # nbs (in ac) = 80000

m1fbeta <- betareg(bt100 ~ distvei1 + disthus + skogkategori + treartgruppe + ac + kant + helling + hohkatb + tretetthet + skogkategori*distvei1,
            data = browse9bro_dist,
            subset = beitetrykkr > 0) # nbs (in ac) = 100000

m1gbeta <- betareg(bt100 ~ distvei1 + disthus + skogkategori + treartgruppe + ac + kant + helling + hohkatb + tretetthet + skogkategori*distvei1,
            data = browse9bro_dist,
            subset = beitetrykkr > 0) # nbs (in ac) = 150000

m1hbeta <- betareg(bt100 ~ distvei1 + disthus + skogkategori + treartgruppe + ac + kant + helling + hohkatb + tretetthet + skogkategori*distvei1,
            data = browse9bro_dist,
            subset = beitetrykkr > 0) # nbs (in ac) = 300000
