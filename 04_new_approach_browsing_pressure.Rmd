...
m4glmm <- glmer(factor(beitetrykkr > 0) ~ disthus_cut210_scale + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet_scale + distvei1_scale*skogkategori + (1|KOMNR),
            family = binomial(),
            data = browse_9_dist)
