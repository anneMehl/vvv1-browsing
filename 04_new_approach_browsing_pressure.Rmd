...
```{r}
m1aglmm <- glmer(factor(beitetrykkr > 0) ~ disthus_scale + distvei1_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet_scale + skogkategori*distvei1_scale + (1|KOMNR),
            family = binomial(),
            data = browse_9)
...
m1aglmm <- glmer(factor(beitetrykkr > 0) ~ disthus_scale + distvei1_scale + skogkategori + treartgruppe + ac_scale + kant + helling_scale + HOH_scale + I(HOH_scale^2) + tretetthet_scale + (1|KOMNR),
            family = binomial(),
