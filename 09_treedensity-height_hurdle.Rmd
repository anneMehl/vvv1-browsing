...
library(AICcmodavg)
candmods <- list(mhusabin, mhusabin_reg)
...
# Plots
library(sjPlot)
# p1husbin <- plot_model(mhusabin_reg, type = c("eff"), transform = NULL, terms = c("disthus_400"))
...
library(bbmle)
ICtab(m16abeta_house, m16beta_house_reg, type = "AIC", weights = TRUE, delta = TRUE)
#                   dAIC df weight
