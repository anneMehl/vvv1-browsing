...
pvars <- c("helling","HOH","ac", "browspres_merged")
...
m16bin <- glmer(factor(proplt > 0) ~ log(distvei2+1) + skogkategori + treartgruppe9 + browspres_merged + helling + HOH + I(HOH^2) +  ac + (1|KOMNR),
family = binomial(),
...
m18bin <- glmer(factor(proplt > 0) ~ log(distvei2+1) + treartgruppe9 + browspres_merged + helling + HOH + I(HOH^2) + (1|KOMNR),
family = binomial(),
data = browse9.6sc) 
...
pvars <- c("distvei2",
           "helling","HOH", "ac", "browspres_merged")
browse9.5mpossc <- browse9.6pos
browse9.5mpossc[pvars] <- lapply(browse9.5mpossc[pvars],scale)

# "disthus", "disthus_200","distvei2",

m0abeta <- glmmTMB(proplt ~ disthus + distvei2 + skogkategori + treartgruppe9 + ac + kant + helling + HOH + I(HOH^2) + browspres_merged + (1|KOMNR),
            data = browse9.5mpossc,
            family = beta_family()) 

m0bbeta <- glmmTMB(proplt ~ disthus_200 + log(distvei2+1) + skogkategori + treartgruppe9 + ac + kant + helling + HOH + I(HOH^2) + browspres_merged + (1|KOMNR),
            data = browse9.5mpossc,
            family = beta_family()) 

m0cbeta <- glmmTMB(proplt ~ log(disthus+1) + log(distvei2+1) + skogkategori + treartgruppe9 + ac + kant + helling + HOH + I(HOH^2) + browspres_merged + (1|KOMNR),
            data = browse9.5mpossc,
            family = beta_family()) 

m0dbeta <- glmmTMB(proplt ~ log(disthus+1) + distvei2 + skogkategori + treartgruppe9 + ac + kant + helling + HOH + I(HOH^2) + browspres_merged + (1|KOMNR),
            data = browse9.5mpossc,
            family = beta_family()) 
