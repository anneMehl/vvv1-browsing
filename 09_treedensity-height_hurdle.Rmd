...
# AIC
AIC(m16beta_house, m16beta_house_reg)
#                   df       AIC
# m16beta_house     12 -809.5930
# m16beta_house_reg 25 -872.8844
library(bbmle)
ICtab(m16beta_house, m16beta_house_reg, type = "AIC", weights = TRUE, delta = TRUE)
...
library(glmmTMB)
load("processdata/browse9.6_regionsc.rda")
browse9.6_regionscpos <- browse9.6_regionsc[browse9.6_regionsc$proplt > 0, ]
